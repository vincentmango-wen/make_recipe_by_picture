...
def save_upload_file(upload_file, upload_dir: str = "app/static/uploads") -> Path:
...
def save_b64_image(b64_json: str, output_dir: str = "app/static/generated", title: str | None = None) -> Path:
